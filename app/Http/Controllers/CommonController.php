...
trait CommonController
{
    ...
    public function saveActivity($data, $action)
    {
        if (auth()->user()) {
            ...
            $data['owner'] = $data['last_updated_by'] = auth()->user()->login_id;
    ...
    public function createUserSettings($login_id)
    {
        $settings = array(
            ...
            ['field_name' => 'display_type', 'field_value' => 'comfortable', 'module' => 'Other', 'owner' => $login_id, 'last_updated_by' => $login_id, 'created_at' => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")],
            ['field_name' => 'theme', 'field_value' => 'skin-purple', 'module' => 'Other', 'owner' => $login_id, 'last_updated_by' => $login_id, 'created_at' => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")]
        );
