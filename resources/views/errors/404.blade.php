...
<html lang="en">
    <head>
        <title>{{ __('404 - Not Found') }} - {{ config('app.brand.name') }}</title>
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center text-center">
                            ...
                            <p>{{ __('Try checking the URL for error, then hit the refresh button on your browser or try found something else in our app') }}.</p>
