...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = array(
            ...
            ['field_name' => 'list_view_records', 'field_value' => '15', 'module' => 'Other', 'owner' => 'sysadmin', 'last_updated_by' => 'sysadmin', 'created_at' => Carbon::now('UTC')->format('Y-m-d H:i:s'), "updated_at" => Carbon::now('UTC')->format('Y-m-d H:i:s')],
            ...
            ['field_name' => 'list_view_records', 'field_value' => '15', 'module' => 'Other', 'owner' => 'admin', 'last_updated_by' => 'admin', 'created_at' => Carbon::now('UTC')->format('Y-m-d H:i:s'), "updated_at" => Carbon::now('UTC')->format('Y-m-d H:i:s')],
