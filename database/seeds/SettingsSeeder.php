...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = array(
            ...
            ['field_name' => 'theme', 'field_value' => 'skin-purple', 'module' => 'Other', 'owner' => 'sysadmin', 'last_updated_by' => 'sysadmin', 'created_at' => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")],
            ...
            ['field_name' => 'theme', 'field_value' => 'skin-purple', 'module' => 'Other', 'owner' => 'admin', 'last_updated_by' => 'admin', 'created_at' => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")],
